# Section Summary — Dynamic Programming (Neetcode)

- Focus: state definition, memoization vs tabulation, common dp families.

Review prompts:
- How to choose state variables for DP? Show examples.
- Practice: coin change, LIS, word break.
