# Section Summary — Stacks (Neetcode)

- Focus: stack for parsing, monotonic stacks, recursion elimination.

Review prompts:
- When to use a monotonic stack; common problems.
- Practice: daily temperatures, evaluate RPN.
