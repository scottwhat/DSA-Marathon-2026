# Section Summary — Two Pointers (Neetcode)

- Focus: left/right pointer techniques, window shrinking/expanding.

Review prompts:
- Explain two-pointer approaches for pair sums and sliding windows.
- Practice: trapping rain water (approach), container with most water.
