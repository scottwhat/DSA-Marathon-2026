# Section Summary — Graphs (Neetcode)

- Focus: traversals, shortest paths, components, cycle detection.

Review prompts:
- Explain BFS for unweighted shortest path and Dijkstra for weighted edges.
- Practice: number of islands, flood-fill, course schedule (topological sort).
