# Section Summary — Linked Lists (Neetcode)

- Focus: pointer manipulation, cycle detection, merging, reversal.

Review prompts:
- Explain Floyd's cycle detection and finding cycle start.
- Practice: reverse list, merge lists, reorder list.
