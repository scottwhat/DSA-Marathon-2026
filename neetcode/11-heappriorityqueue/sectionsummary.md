# Section Summary — Heaps / Priority Queues (Neetcode)

- Focus: top-k patterns and using heaps for streaming/merge problems.

Review prompts:
- How to implement max-behavior with Python `heapq`?
- Practice: k closest points, median maintenance (conceptual).
