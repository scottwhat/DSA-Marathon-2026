# Section Summary — Binary Tree Advanced (Structy)

- Focus: BST operations, building trees from traversals, balancing checks.

Review prompts:
- How to construct tree from preorder/inorder and why it works.
- Practice: LCA, tree balance checks, postorder/building trees.
