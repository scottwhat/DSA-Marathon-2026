# Section Summary — Binary Tree (Structy)

- Focus: DFS/BFS templates, recursive vs iterative traversals, path problems.

Review prompts:
- When to use BFS (queue) vs DFS (stack/recursion) for tree problems?
- Practice: depth-first values, tree path sums, level averages.
