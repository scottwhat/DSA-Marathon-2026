# Section Summary — Array & Strings (Structy)

- Focus: indexing, two-pointer, sliding window, sorting tradeoffs.

Review prompts:
- Describe approaches for subarray sums and merge-sort based solutions.
- Practice: running sum, detect dictionary, lexical order tasks.
