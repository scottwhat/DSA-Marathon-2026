# Section Summary — Graphs Advanced (Structy)

- Focus: weighted graphs, shortest path variants, topological sorts and DAG problems.

Review prompts:
- Practice: Dijkstra, topological order, weighted connectivity problems.
