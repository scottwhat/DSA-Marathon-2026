# Section Summary — Recursion & Backtracking

- Core concepts: recursion trees, branching factor, pruning, backtracking state restoration.
- Key patterns: generate permutations/subsets/combinations, constraint checking early to prune, DFS recursion for grid problems.
- Implementation tips: use iterative generators carefully; pass mutable state with care.

Review prompts:
- Explain backtracking structure and where pruning saves time.
- How to generate combinations vs permutations and avoid duplicates.
- Practice: subsets, permutations, N-queens (backtracking outline).
